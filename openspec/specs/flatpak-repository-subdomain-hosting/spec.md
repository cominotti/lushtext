# flatpak-repository-subdomain-hosting Specification

## Purpose
Define how the official Cominotti Flatpak repository is hosted under `flatpak.cominotti.dev`, including public URLs, static hosting constraints, fallback hosting, and maintainer setup.
