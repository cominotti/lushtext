# modal-geometry-stability Specification

## Purpose
Define app-wide modal geometry stability requirements for dialogs, popups, and modal browser surfaces whose content can change after presentation.
