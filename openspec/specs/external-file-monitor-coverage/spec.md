# external-file-monitor-coverage Specification

## Purpose
Define LushText's external file-monitor coverage so disk changes, reload flows,
and self-save suppression stay covered through user-visible behavior.
