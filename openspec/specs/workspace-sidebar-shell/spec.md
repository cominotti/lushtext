...
## Purpose
Define the user-facing workspace sidebar shell, including the fixed scope row, empty-state behavior, single-root workspace sections, and section-local drill-down navigation.
## Requirements
...
- **AND** it does not show a replace-root control
