# stable-fuzz-corpus-replay Specification

## Purpose
Define LushText's stable fuzz corpus replay lane so committed fuzz seeds can be
replayed deterministically on stable Rust without requiring coverage-guided fuzz
tooling, GTK, or desktop-session infrastructure.
