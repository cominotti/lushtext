# gtk-lush-internal-platform Specification

## Purpose

Define GTK Lush as a stable in-tree LushText platform, with explicit
stewardship rules for preserving local value while keeping publication,
repository graduation, and upstreaming as dormant tracks that require a later
approved proposal.
