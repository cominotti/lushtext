# snap-sandbox-identity Specification

## Purpose
Define LushText's Snap identity, strict-confinement permission posture,
workspace folder access boundary, edge-only release contract, and deterministic
