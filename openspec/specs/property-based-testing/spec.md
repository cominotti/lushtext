...
## Purpose
Define LushText's property-based testing lane so generated-input coverage, runtime bounds, regression persistence, documentation, and GTK/session boundaries stay explicit and reviewable.
