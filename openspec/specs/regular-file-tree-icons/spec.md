# regular-file-tree-icons Specification

## Purpose
Define the workspace file tree's icon presentation contract: actual filesystem content uses regular GNOME/libadwaita themed icons, while sidebar controls and synthetic status rows remain symbolic.
