...
Define LushText's SonarQube Cloud CI analysis contract, including trusted-ref uploads, Rust/GTK scanner prerequisites, scanner source scope, local API verification, and finding triage expectations.
