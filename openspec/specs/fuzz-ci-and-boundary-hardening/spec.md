# fuzz-ci-and-boundary-hardening Specification

## Purpose
Define LushText's fuzz CI and boundary-hardening coverage so stable corpus
replay, bounded fuzz smoke, corrupt persistence decode inputs, Markdown byte
boundaries, and fuzz command discoverability stay explicit and reviewable.
