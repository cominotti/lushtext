...
Adoption evidence SHALL remain bounded and privacy-preserving. It MUST NOT include raw
private user content, full external source trees, unbounded logs, raw image
data embedded in markdown, document text, note bodies, draft bodies,
