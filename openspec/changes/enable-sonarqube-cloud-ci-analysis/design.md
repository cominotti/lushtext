...
- [Risk] Quality-gate waiting increases CI duration or flakes on SonarCloud processing delays -> Mitigation: use a bounded timeout and keep the job isolated from the core Rust lint/test diagnostics.
