...
`gtk-lush-signals` is a `0.0.0` placeholder reservation for the future GTK
Lush signal-lifetime crate.
...
signal handler, binding, and controller lifetime helpers against
