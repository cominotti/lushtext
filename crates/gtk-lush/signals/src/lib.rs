...
//! Placeholder reservation for GTK Lush signal lifetime helpers.
//!
...
//! signal lifetime API, documentation, and LushText migration against the
//! program governance in `crates/gtk-lush/GOVERNANCE.md`.
