...
- `widget-wiring.md` — GTK widget composition, signal wiring, declarative projection bindings, state-extreme coverage, menu popup lifecycle, tab projection state, live paned-validation, and allocation-frame animation rules
