...
- `ui.md` — UI, theming, state-extreme visibility checks, adaptive dialog navigation, TextView child-anchor geometry, adaptive bottom-sheet sizing, and GTK paned geometry/animation conventions
- `widget-wiring.md` — GTK widget composition, signal wiring, state-extreme coverage, menu popup lifecycle, tab projection state, live paned-validation, and allocation-frame animation rules
