...
- `crates/gtk-lush/` — governed `0.0.0` GTK Lush family crates for extracting reusable GTK4/Libadwaita patterns; `signals` and `settle` have functional in-tree Phase 2 APIs but are not Phase 5 publication-ready
