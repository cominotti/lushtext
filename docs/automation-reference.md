...
| <span id="atspi-anchor-open-popover-search-recent-documents"></span>`atspi-anchor-open-popover-search-recent-documents` | Open popover | `search box` | `Recent documents search` | Filters recent documents | Stable public accessibility anchor |
...
| <span id="atspi-anchor-open-popover-button-remove-recent-document"></span>`atspi-anchor-open-popover-button-remove-recent-document` | Open popover | `button` | `Remove recent document` | Removes one recent-document row | Stable public accessibility anchor |
