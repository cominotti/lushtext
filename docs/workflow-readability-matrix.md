...
- facade: `crates/lushtext-core/src/ui/window/geometry/mod.rs` — **240 physical lines of 370**
...
- seam value objects: `AdaptiveShellInputs`, in `policy.rs`
