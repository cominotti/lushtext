...
- seam value objects: the eviction generation identity, owned by the coordinator, which `.agents/rules/rust.md` names as itself the seam value object
