...
- mutation parity: [`mutation-minimap-policy.md`](../openspec/changes/migrate-minimap-workflow-readability/evidence/mutation-minimap-policy.md)
  — relocation parity and extraction gain reported **separately**, each naming its
  invocation and file-level anchors, with the unfilterable 34-mutant floor stated
- data-safety fixes landed with this migration: [`data-safety.md`](../openspec/changes/migrate-minimap-workflow-readability/evidence/data-safety.md)
