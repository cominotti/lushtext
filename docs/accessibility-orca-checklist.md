...
| A11Y-PREFERENCES-PAGES, A11Y-PREFERENCES-DATA-SCAN, A11Y-PREFERENCES-DATA-SET-ASIDE, A11Y-PREFERENCES-DATA-SET-ASIDE-REVIEW | Preferences and Data page scan/migration and Preserved Drafts surfaces | Orca reports page navigation, rows, switches, combo/spin values, scan progress, repair or retry actions, migration warnings, the Preserved Drafts summary (count, size, bound state), Delete All and its count-and-size confirmation, and the review notice, without any preserved body. | | | |
